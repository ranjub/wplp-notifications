    ...
    ?>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="number" name="affiliate_percentage" id="affiliate_percentage" min="0" max="100" value="<?php echo esc_attr(get_user_meta($user->ID, 'affiliate_percentage', true)); ?>">
                </td>
            </tr>
        </table>
<?php
